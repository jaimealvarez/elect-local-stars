...
{
  title: "PRIMER RENGLÓN",
  principal: { name: "JOHANNA ZAMBRANO", role: "Principal" as const, bio: "Ingeniera de sistemas (2005) y Maestría en ingeniería (2008)\n\nEn Uniandinos ha sido: asambleísta, presidente y vicepresidente de Sisandes (luego de liderar la reactivación del capítulo), miembro de la junta de Caminandes y miembro del comité de tecnología. Ha organizado eventos con el departamento de ing. de sistemas de Uniandes y ha apoyado proyectos de estudiantes y de emprendedores\n\nProfesionalmente, se desempeña como arquitecta de seguridad de la información y gestión de riesgos en proyectos con entidades del Estado colombiano. A través de su empresa, ofrece una API de última generación como proveedor tecnológico autorizado de facturación electrónica, destacándose por su enfoque en seguridad fiscal. Asociada de innovación del GIMI.\n\nhttps://www.linkedin.com/in/johanna-zambrano-r/", photo: "/lovable-uploads/9e5584d7-21a4-4180-bea2-e6505e869aa5.jpg" },
  substitute: { name: "JOSÉ LUIS SANTIAGO", role: "Suplente" as const, bio: "Ingeniero eléctrico, MBA (Uniandes 2018), especialista en economía y certificaciones en: PMP®, PMI-ACP®, PMI-RMP®.\n\nLíder de proyectos de la industria energética y servicios públicos, con más de quince años de experiencia. VP educación PMI Bogotá 2022-2024. Docente Universitario en posgrado. Speaker en congresos y conversatorios de comunidad de gerencia de proyectos.\n\nhttps://www.linkedin.com/in/joseluisantiago/", photo: "/lovable-uploads/ad1e0870-e4e2-4e30-9bc5-bf5a00b4da91.jpg" }
},
{
  title: "SEGUNDO RENGLÓN",
  principal: { name: "JUAN JOSÉ GARZÓN", role: "Principal" as const, bio: "Geociencias (2021) Becado por la Universidad de los Andes.\n\nEn Uniandinos ha estado desde su graduación y en el capítulo Geociencias ha sido vicepresidente (2023–2024) y Presidente desde 2024, liderando iniciativas para fortalecer nuestra comunidads.\n\nExperiencia como profesor de cátedra de la Universidad de Los Andes en Paleontología y también ha potenciado su perfil hacia la industria IT, combinando lo técnico con lo comercial, algo que también espera poner a disposición de UNIANDINOS.\n\nhttps://www.linkedin.com/in/juan-jose-garzon-valencia/", photo: "/lovable-uploads/6d45ddc7-e1c0-4829-91e5-a1f1a71ffe58.jpg" },
  substitute: { name: "NATALIA DURÁN", role: "Suplente" as const, bio: "Ingeniera Biomédica (2020). Experiencia laboral en manejo de datos (ETL) y optimizacion de sistemas para manejo más óptimo de agentes (IA). \n\nEn Uniandinos ha sido presidenta 2025-2026 Capítulo de Ingeniería Biomédica (Ibioandinos). Al ser un capítulo joven, buscó conectar a los egresados, brindar apoyo a los estudiantes cerca a graduarse y dar a conocer a la comunidad lo que hace un ingeniero biomédico. Su como asambleísta es aprender más sobre cómo se maneja Uniandinos y brindar esa visión desde una carrera con más jóvenes para fortalecer la comunidad.\n\nExperiencia laboral en manejo de datos (ETL) y optimización de sistemas para manejo más óptimo de agentes (IA).\n\nhttps://www.linkedin.com/in/natand-durcast/", photo: "/lovable-uploads/dc6cc85f-e7b8-4e05-ade8-e348dbe6b6d0.jpg" }
},
{
