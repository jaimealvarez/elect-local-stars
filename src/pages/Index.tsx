...
{ title: "SOSTENIBILIDAD Y CRECIMIENTO", description: "Fortalecer la oferta de valor para afiliados y sus familias (convenios, empleabilidad y networking), con especial atención al costo de alimentos y bebidas.\n\nAsegurar la sostenibilidad del proyecto del plan parcial, mediante la contratación de un estructurador que defina su alcance y establezca términos de referencia para contratar al constructor, mitigando los riesgos.\n\nRevisar la estructura interna versus la oferta de servicios, para responder mejor a las necesidades de los asociados. Esto incluye capacitar al equipo para que se mejore el servicio.\n\nFortalecer los comités de Junta Directiva y los procesos que permitan aprovechar la experiencia de los egresados, en particular reactivando el Comité de Tecnología y el Consejo de Equidad y Diversidad.\n\nGarantizar estabilidad en la gestión, eliminando la interinidad en cargos clave como la Gerencia General y otras áreas de la Asociación.", image: "/lovable-uploads/f57c8cfd-2fcf-4d1c-af67-3849f76db688.jpg" },
{ title: "FORTALECER LA COMUNIDAD", description: "Fortalecer los programas de empleabilidad, emprendimiento y financiación de estudios.\n\nImpulsar la relevancia de Uniandinos en el sector empresarial para disponer de un apalancamiento que apoye a emprendedores y profesionales.\n\nEmpoderar los capítulos y grupos de interés como motores de la comunidad.\n\nFomentar redes de participación que mantengan el vínculo con la Universidad.\n\nPromover una comunidad más cercana, escuchando a los egresados y fortaleciendo su participación.\n\nIntegrar al consejo estudiantil en los capítulos y en la vida de la asociación, para que sean nuestros embajadores en Uniandes.\n\nFortalecer la oferta cultural y los programas de filantropía.\n\nMejorar la experiencia tecnológica de los asociados, con el soporte del comité de tecnología.", image: "/lovable-uploads/722e55da-cf68-4aba-b387-a3e63ed3fef1.jpg" },
{ title: "PARTICIPACIÓN Y PROYECCIÓN DE LA COMUNIDAD", description: "Establecer un canal directo de comunicación entre la Junta Directiva y la comunidad, mediante una herramienta tecnológica.\n\nImpulsar una revisión al direccionamiento estratégico, con participación de la comunidad y reglamentar el proceso para que se haga periódicamente (cada cinco años).\n\nFortalecer el vínculo con estudiantes mediante encuentros y la creación de un capítulo estudiantil.\n\nReactivar el consejo de jóvenes como espacio de participación y generación de propuestas.\n\nCrear redes de participación que integren a asociados, estudiantes y profesores, fomentando el intercambio de conocimiento y la construcción de comunidad.\n\nFormalizar la certificación del voluntariado para su reconocimiento académico y profesional. Esto es de especial importancia para los jóvenes", image: "/lovable-uploads/be5b7ca3-4a3c-4092-ab0f-1885ac1cc2d1.jpg" }];
